    ...
    void mediaGet(int *Alunos_quant, float *NOTAS, float *MEDIA, float *Maior_nota, float *Menor_nota, int *Acima_media, float *MEDIANA, int *Moda_pos, int Novos_alunos_bool, int *Maior_nota_pos, int *Menor_nota_pos, int Novos_alunos, float *Notas_org, float *Soma_media){
    ...
    void maiorMenorAcimaMedia(int *Alunos_quant, float *NOTAS, float *MEDIA, float *Maior_nota, float *Menor_nota, int *Acima_media, float *MEDIANA, int *Moda_pos, int Novos_alunos_bool, int *Maior_nota_pos, int *Menor_nota_pos, int Novos_alunos, float *Notas_org, float *Soma_media){
    ...
    void medianaGet(int *Alunos_quant, float *NOTAS, float *MEDIA, float *Maior_nota, float *Menor_nota, int *Acima_media, float *MEDIANA, int *Moda_pos, int Novos_alunos_bool, int *Maior_nota_pos, int *Menor_nota_pos, int Novos_alunos, float *Notas_org, float *Soma_media){
        for(int i = 0; i<*Alunos_quant; i++){
            Notas_org[i] = NOTAS[i];
        }
    ...
    void modaGet(int *Alunos_quant, float *NOTAS, float *MEDIA, float *Maior_nota, float *Menor_nota, int *Acima_media, float *MEDIANA, int *Moda_pos, int Novos_alunos_bool, int *Maior_nota_pos, int *Menor_nota_pos, int Novos_alunos, float *Notas_org, float *Soma_media){
    ...
    void notasManipulation(int *Alunos_quant, float *NOTAS, float *MEDIA, float *Maior_nota, float *Menor_nota, int *Acima_media, float *MEDIANA, int *Moda_pos, int Novos_alunos_bool, int *Maior_nota_pos, int *Menor_nota_pos, int Novos_alunos, float *Notas_org, float *Soma_media){
        ...
        mediaGet(Alunos_quant, NOTAS, MEDIA, Maior_nota, Menor_nota, Acima_media, MEDIANA, Moda_pos, Novos_alunos_bool, Maior_nota_pos, Menor_nota_pos, Novos_alunos, Notas_org, Soma_media);
        maiorMenorAcimaMedia(Alunos_quant, NOTAS, MEDIA, Maior_nota, Menor_nota, Acima_media, MEDIANA, Moda_pos, Novos_alunos_bool, Maior_nota_pos, Menor_nota_pos, Novos_alunos, Notas_org, Soma_media);
        medianaGet(Alunos_quant, NOTAS, MEDIA, Maior_nota, Menor_nota, Acima_media, MEDIANA, Moda_pos, Novos_alunos_bool, Maior_nota_pos, Menor_nota_pos, Novos_alunos, Notas_org, Soma_media);
        modaGet(Alunos_quant, NOTAS, MEDIA, Maior_nota, Menor_nota, Acima_media, MEDIANA, Moda_pos, Novos_alunos_bool, Maior_nota_pos, Menor_nota_pos, Novos_alunos, Notas_org, Soma_media);
